...
export async function failedContractInvoicePatientEmailNotifier({
  patientName,
  patientEmail,
  contractNumber,
  invoiceNumber,
  ...
  const htmlBody = `
       ...
       <head>
         <style>
           ...
           a.button { padding: 12px 25px; background-color: #ffc107; color: #333 !important; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 10px; font-weight: 500; border: 1px solid #e0a800}
       ...
       <body>
         <div class="container">
           ...
           <p>Esta fatura é referente ao seu contrato Nº ${contractNumber} para o serviço "${serviceName}". A data de vencimento original era ${formattedDueDate}.</p>
