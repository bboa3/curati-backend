...
const schema = a.schema({
  ...
  deliveryAssignment: a.model({
    ...
    estimatedDriverCommission: a.float().required(),
    pickupSnippet: a.string().required(),
    destinationSnippet: a.string().required(),
