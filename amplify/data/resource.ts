...
const schema = a.schema({
  ...
  user: a.model({
    ...
    .secondaryIndexes(index => [index('authId').queryField('listByAuthId').name('listByAuthId')])
  ...
  patient: a.model({
    ...
    .secondaryIndexes(index => [index('userId').queryField('listByUserId').name('listByUserId')])
    .disableOperations(['subscriptions', 'delete']),
